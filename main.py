...
# accessing parameter from the user for the classifier
...
# parameter distribution to the classifier
...
st.write(f"Classifier used is =  {classifier_name}")
st.write(f"Accuracy of the Classifier is =  {acc}")
